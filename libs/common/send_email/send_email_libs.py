...
username = "877415861@qq.com"              #qq账户*
authorization_code = "yxjfdxpljejbbfeh"     #qq邮箱授权码*
from_email = "877415861@qq.com"            #发送的邮箱
...
if __name__ == "__main__":
    ...
    # 测试发送文本邮件
    #send_fail = send_qq_plain_email("877415861@qq.com", to_email, "第一课", content)

    #测试发送html邮件
    send_fail = send_qq_html_email("877415861@qq.com", to_email, "第一课", content)
    #测试发送带附件邮件
    #send_fail = send_qq_attach_email("877415861@qq.com", to_email, "第一课", content, attachs)
    #测试发送同时带图片和附件的邮件
    #send_fail = send_qq_img_email("877415861@qq.com", to_email, "第一课", img_content, attachs, imgname)
    print send_fail
